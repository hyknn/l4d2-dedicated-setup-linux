...
public void OnPluginStart()
{
	...
	( g_ConVarMethod 				= CreateConVar("sm_restart_empty_method", 					"1", 	"When server is empty, what to do? 1 - _restart, 2 - crash (use if method # 1 is not work), 3 - just change map", CVAR_FLAGS)).AddChangeHook(OnCvarChanged);
